 ...
 * @brief CodeSourcery Sourcery G++ Lite (with CS3) \n
 *   modified by Ch.Troll
 * @version V1.0
 * @date    2011-02-08
 * @authors  CodeSourcery \n
 *          Prof. Troll \n
 *          WH Zwickau  \n
 *          Fak. Elektrotechnik - Informationstechnik\n
 *          Modul: Embedded Systems\n 
 *          mail:  Chritian.Troll@fh-zwickau.de 
 * \verbatim
***********************************************/
...
/* Copy data from ROM to RAM */
	LDR     R1, = _etext 					/* source */
	LDR     R2, = __cs3_region_start_ram	/* destination*/
...
/* Clear .bss section (Zero init) */
	MOV     R0, #0
	LDR     R1, = _sbss /*__bss_start__*/
	LDR     R2, = _ebss /*__bss_end__ */
	CMP     R1,R2
	BEQ     BSSIsEmpty
LoopZI:
	CMP     R1, R2
